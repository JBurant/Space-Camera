...
In order to Deploy a new jar file, a so called fat jar must be created. This can be done for example using the  JarSplice tool \cite{JarSplice}, which packs the project libraries as well as corresponding native libraries into one executable jar folder.
