...
The coordinate system of the rendered left part of the window is classical 3D Cartesian system, which spans from -9 to 9 for the x (horizontal) and -7 to 7 for the y coordinates (vertical). As for the z coordinates (representing the height), it spans from -10 to 0, while -10 being the coordinate of the surface plane. The point z=0 is at the overview, top camera location and -10 is on the surface.
...
\caption{Illustration of the angles and the axes of the layout in the developped software.\label{AnglesAndAxes}}
\end{figure}
